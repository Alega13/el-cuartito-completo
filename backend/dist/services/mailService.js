...
exports.sendPickupReadyEmail = exports.sendShipOrderEmail = exports.sendShippingNotificationEmail = exports.sendOrderConfirmationEmail = void 0;
...
const sendOrderConfirmationEmail = (orderData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        console.log('📧 Customer email:', (_a = orderData.customer) === null || _a === void 0 ? void 0 : _a.email);
            ...
            html: `
                <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px; color: #333;">
                    ...
                    <div style="margin-bottom: 30px;">
                        <h2 style="font-size: 20px; font-weight: bold; margin-bottom: 10px;">¡Gracias por tu compra, ${customer === null || customer === void 0 ? void 0 : customer.firstName}!</h2>
...
const sendShippingNotificationEmail = (orderData, shipmentInfo) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const customerName = ((_b = orderData.customer) === null || _b === void 0 ? void 0 : _b.firstName) || 'Cliente';
        if (!customerEmail) {
            console.error('❌ Cannot send email: No customer email found.');
            return;
        }
...
const sendShipOrderEmail = (orderData, shipmentInfo) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const customerEmail = ((_a = orderData.customer) === null || _a === void 0 ? void 0 : _a.email) || orderData.customerEmail;
        const customerName = ((_b = orderData.customer) === null || _b === void 0 ? void 0 : _b.firstName) || orderData.customerName || 'Cliente';
        const { data, error } = yield resend.emails.send({
...
const sendPickupReadyEmail = (orderData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (error)
            console.error('❌ Resend Error (Pickup):', error);
    }
    catch (error) {
