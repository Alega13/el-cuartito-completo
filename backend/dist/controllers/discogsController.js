    ...
    try {
        ...
        for (const order of orders) {
            try {
                ...
                setTimeout(() => {
                    var _a;
                    const invoiceData = (0, invoiceService_1.buildInvoiceFromDiscogsSale)(saleId, { date: orderDate.toISOString().split('T')[0], customerName: (_a = order.buyer) === null || _a === void 0 ? void 0 : _a.username, shippingAddress: order.shipping_address }, items, netAmount, shipping);
                ...
                setTimeout(() => {
                    ...
                    (0, mailService_1.sendSaleNotificationEmail)({
                        ...
                        paymentMethod: 'Discogs Payout',
                        customerName: ((_a = order.buyer) === null || _a === void 0 ? void 0 : _a.username) || undefined,
                        saleId,
                        date: orderDate.toISOString().split('T')[0],
        ...
        for (const line of dataLines) {
            try {
                ...
                yield db.collection('products').add({
                    ...
                    genre: (release.styles || [])[0] || (release.genres || [])[0] || 'Unknown',
                    genre2: (release.styles || [])[1] || null,
                    genre3: (release.styles || [])[2] || null,
                    year: release.year || 0,
...
const refreshMetadata = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const updatedData = {
            ...
            genre: (release.styles || [])[0] || (release.genres || [])[0] || (product === null || product === void 0 ? void 0 : product.genre) || 'Unknown',
            genre2: (release.styles || [])[1] || null,
            genre3: (release.styles || [])[2] || null,
